...
public class PanelRuleta extends javax.swing.JPanel {
    ...
    public void SumarApuesta(int universalCellCode, int valor) {
        int Apuesta = getApuesta(universalCellCode);
        if(Apuesta>0){
            setCoinValue(cells.get(universalCellCode).coin, valor+Apuesta); 
        }else{
            setCoinValue(cells.get(universalCellCode).coin, valor);
        }      
    }
